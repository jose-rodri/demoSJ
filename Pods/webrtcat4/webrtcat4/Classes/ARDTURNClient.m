...
// static NSString *kTURNRefererURLString = @"https://vincles.i2cat.net:12345";
...
- (void)requestServersWithCompletionHandler:
    ...
    NSLog(@"requestServersWithCompletionHandler");
